...
import '../App.css'
const Page = () => {
  const [m00,setM00]=React.useState(" ");
  const [m01,setM01]=React.useState(" ");
  const [m02,setM02]=React.useState(" ");
  const [m03,setM03]=React.useState(" ");
  const [m04,setM04]=React.useState(" ");
  const [m05,setM05]=React.useState(" ");
  const [m06,setM06]=React.useState(" ");
  const [m07,setM07]=React.useState(" ");
  const [m08,setM08]=React.useState(" ");
  //
  const [m10,setM10]=React.useState(" ");
  const [m11,setM11]=React.useState(" ");
  const [m12,setM12]=React.useState(" ");
  const [m13,setM13]=React.useState(" ");
  const [m14,setM14]=React.useState(" ");
  const [m15,setM15]=React.useState(" ");
  const [m16,setM16]=React.useState(" ");
  const [m17,setM17]=React.useState(" ");
  const [m18,setM18]=React.useState(" ");
  //
  const [m20,setM20]=React.useState(" ");
  const [m21,setM21]=React.useState(" ");
  const [m22,setM22]=React.useState(" ");
  const [m23,setM23]=React.useState(" ");
  const [m24,setM24]=React.useState(" ");
  const [m25,setM25]=React.useState(" ");
  const [m26,setM26]=React.useState(" ");
  const [m27,setM27]=React.useState(" ");
  const [m28,setM28]=React.useState(" ");
  //

  const [m30,setM30]=React.useState(" ");
  const [m31,setM31]=React.useState(" ");
  const [m32,setM32]=React.useState(" ");
  const [m33,setM33]=React.useState(" ");
  const [m34,setM34]=React.useState(" ");
  const [m35,setM35]=React.useState(" ");
  const [m36,setM36]=React.useState(" ");
  const [m37,setM37]=React.useState(" ");
  const [m38,setM38]=React.useState(" ");

  //
  const [m40,setM40]=React.useState(" ");
  const [m41,setM41]=React.useState(" ");
  const [m42,setM42]=React.useState(" ");
  const [m43,setM43]=React.useState(" ");
  const [m44,setM44]=React.useState(" ");
  const [m45,setM45]=React.useState(" ");
  const [m46,setM46]=React.useState(" ");
  const [m47,setM47]=React.useState(" ");
  const [m48,setM48]=React.useState(" ");

  //

  const [m50,setM50]=React.useState(" ");
  const [m51,setM51]=React.useState(" ");
  const [m52,setM52]=React.useState(" ");
  const [m53,setM53]=React.useState(" ");
  const [m54,setM54]=React.useState(" ");
  const [m55,setM55]=React.useState(" ");
  const [m56,setM56]=React.useState(" ");
  const [m57,setM57]=React.useState(" ");
  const [m58,setM58]=React.useState(" ");

  const [m60,setM60]=React.useState(" ");
  const [m61,setM61]=React.useState(" ");
  const [m62,setM62]=React.useState(" ");
  const [m63,setM63]=React.useState(" ");
  const [m64,setM64]=React.useState(" ");
  const [m65,setM65]=React.useState(" ");
  const [m66,setM66]=React.useState(" ");
  const [m67,setM67]=React.useState(" ");
  const [m68,setM68]=React.useState(" ");

  //
  const [m70,setM70]=React.useState(" ");
  const [m71,setM71]=React.useState(" ");
  const [m72,setM72]=React.useState(" ");
  const [m73,setM73]=React.useState(" ");
  const [m74,setM74]=React.useState(" ");
  const [m75,setM75]=React.useState(" ");
  const [m76,setM76]=React.useState(" ");
  const [m77,setM77]=React.useState(" ");
  const [m78,setM78]=React.useState(" ");

  //
  const [m80,setM80]=React.useState(" ");
  const [m81,setM81]=React.useState(" ");
  const [m82,setM82]=React.useState(" ");
  const [m83,setM83]=React.useState(" ");
  const [m84,setM84]=React.useState(" ");
  const [m85,setM85]=React.useState(" ");
  const [m86,setM86]=React.useState(" ");
  const [m87,setM87]=React.useState(" ");
  const [m88,setM88]=React.useState(" ");
...
<div class="green"><input class="cell g1" type="text"
 value={m88}  onChange={(e)=>{setM88(e.target.value)}}/></div>
   ...
   <button style={{margin:"13px", padding:"5px", paddingLeft:"8px", paddingRight:"10px", marginLeft:"29%"}} onClick={clear}>Clear</button>
<button style={{margin:"13px",padding:"5px",paddingLeft:"10px",paddingRight:"10px",marginLeft:"10%",color:"green"}}  onClick={magic}>Generate Answer</button>
<button style={{margin:"13px",padding:"5px",paddingLeft:"10px",paddingRight:"10px",marginLeft:"10%"}} onClick={handel}>Generate Random</button>
